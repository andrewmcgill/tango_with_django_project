...
class UserProfile(models.Model):
    # UserProfile linked to User model instance
    # don't inherit - other apps may want to access User
...
class Category(models.Model):
    NAME_MAX_LENGTH = 128
    name = models.CharField(max_length=NAME_MAX_LENGTH, unique=True) # every category name must be unique
